...
public class Times {
   ...
   */
  public static long get(ITimeImp time, TimeUnit timeUnit) {
   ...
   */
  public static long getDiff(ITimeImp time, TimeUnit timeUnit, long startTime) {
   ...
   */
  public static long getMillisecondsSince(ITimeImp time,
   ...
   * @return Milliseconds elapsed since the previous milliseconds
   */
  public static long getMsSince(ITimeImp time, long previousMs) {
   ...
   */
  public static long getMicrosSince(ITimeImp time, long previousMicros) {
   ...
   */
  public static long getNanosecondsSince(ITimeImp time, long previousNanoseconds) {
   ...
   * @return Nanoseconds elapsed since the previous nanoseconds
   */
  public static long getNanosSince(ITimeImp time, long previousNanos) {
   ...
   */
  public static int getSecondsSince(ITimeImp time, int previousSeconds) {
   ...
   * @return Seconds elapsed since the previous seconds
   */
  public static int getSecSince(ITimeImp time, int previousSec) {
